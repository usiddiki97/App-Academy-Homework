...
# checked its value - there was no way a parent node could be linked back to
# itself by a child node. Now, though, anything goes - our graph could link
# back on itself and catch us in a loop if we're not careful!
...
# nodes you've visited. You only want your bfs method to continue as long as
# it is encountering new nodes. Try running bfs(a, "f") again until the method
# returns nil.
